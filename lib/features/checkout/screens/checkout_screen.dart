        ...
        return GetBuilder<CheckoutController>(
          builder: (checkoutController) {
            ...
            return GetBuilder<CouponController>(builder: (couponController) {
              ...
              double total = 0;
              if(couponDiscount > 0){
              total = _calculateTotal(subTotal, deliveryCharge, discount = 0, couponDiscount, taxIncluded, tax, showTips, checkoutController.tips, additionalCharge, extraPackagingCharge);  
              }
              else{
               total = _calculateTotal(subTotal, deliveryCharge, discount, couponDiscount, taxIncluded, tax, showTips, checkoutController.tips, additionalCharge, extraPackagingCharge);
              }
